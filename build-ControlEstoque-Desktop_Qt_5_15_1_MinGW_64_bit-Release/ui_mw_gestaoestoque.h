...
public:
    ...
    QLabel *label_11;
    QLineEdit *txt_ge_porcevenda;
    QVBoxLayout *verticalLayout_8;
    QLabel *label_12;
    QLineEdit *txt_ge_fornecedor;
    QLabel *lb_ge_valorvenda;
    ...
    void setupUi(QDialog *mw_gestaoEstoque)
    {
        ...
        btn_novoproduto->setFocusPolicy(Qt::NoFocus);
        ...
        btn_gravarnovoproduto->setFocusPolicy(Qt::NoFocus);
        ...
        layoutWidget1->setGeometry(QRect(20, 30, 114, 46));
        ...
        txt_ge_porcevenda = new QLineEdit(layoutWidget2);
        txt_ge_porcevenda->setObjectName(QString::fromUtf8("txt_ge_porcevenda"));

        verticalLayout_7->addWidget(txt_ge_porcevenda);
        ...
        lb_ge_valorvenda = new QLabel(layoutWidget2);
        lb_ge_valorvenda->setObjectName(QString::fromUtf8("lb_ge_valorvenda"));
        lb_ge_valorvenda->setFont(font);
        lb_ge_valorvenda->setStyleSheet(QString::fromUtf8("color:#FA023C;"));

        verticalLayout_9->addWidget(lb_ge_valorvenda);
    ...
    void retranslateUi(QDialog *mw_gestaoEstoque)
    {
        ...
        label_11->setText(QCoreApplication::translate("mw_gestaoEstoque", "Porcentagem Venda", nullptr));
        label_12->setText(QCoreApplication::translate("mw_gestaoEstoque", "Fornecedor", nullptr));
        lb_ge_valorvenda->setText(QCoreApplication::translate("mw_gestaoEstoque", "R$", nullptr));

...
public:
    ...
    void setupUi(QDialog *mw_logar)
    {
        ...
        mw_logar->resize(321, 160);
        layoutWidget = new QWidget(mw_logar);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(20, 0, 271, 131));
    ...
    {
        mw_logar->setWindowTitle(QCoreApplication::translate("mw_logar", "Tela Login", nullptr));
        ...
        txt_senha->setText(QCoreApplication::translate("mw_logar", "123", nullptr));
